...
<html lang="ar">
    <head>
        ...
        <link rel="stylesheet" href="../css/%D8%B1%D8%A4%D9%8A%D8%A9%20%D8%A7%D9%84%D9%85%D8%AF%D8%B1%D8%B3%D8%A9.css">
        <link rel="stylesheet" href="../css/%D8%B4%D8%A7%D8%B4%D8%A7%D8%AA%20%D8%B1%D8%A4%D9%8A%D8%A9%20%D8%A7%D9%84%D9%85%D8%AF%D8%B1%D8%B3%D8%A9.css">
    </head>
    <body>
        <div class="all-element">
            ...
            <!--رؤية المدرسة-->
            <section>
                <div class="version-school">
                    <div class="version-img-word">
                        <div class="container">
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="version-img">
                                        <img src="<?php echo $rowabout['versionImg'] ?>">
                                    </div>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                        <div class="version-word">
                                            <h2><?php echo $rowabout['versionAdd']; ?></h2>
                                            <span>
                                                <?php echo $rowabout['versionText']; ?>
                                            </span>
                                        </div>
                                    </div>
                                </div>
            ...
            <!------------------------------------------------------------------------------------------------>
            <!--العنوان-->
            <section class="address adress-version-school">
                <div class="container">
                    <div class="row">
                        <div class="col">
                        ...
                        <div class="col">
                            <div class="inforamtion-call inforamtion-call-version-school">
            ...
            <!------------------------------------------------------------------------------------------------->
            <!--الفوتر-->
            <footer class="footer footer-version-school">
                <div class="container">
